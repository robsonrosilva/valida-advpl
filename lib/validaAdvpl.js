...
class ValidaAdvpl {
    ...
    validacao(texto, path) {
        ...
        for (var key in linhas) {
            ...
            if (!emComentario) {
                ...
                if (!cBeginSql &&
                    ...
                    objeto.aErros.push(new erros_1.Erro(parseInt(key), parseInt(key), i18n.__("validaAdvpl.queryNoEmbedded"), erros_1.Severity.Warning));
                    FromQuery = false;
                    cSelect = false;
                }
                if (linha.search(/(\ |\t|\'|\")+DELETE+(\ |\t)+FROM+(\ |\t)/) !== -1) {
                    objeto.aErros.push(new erros_1.Erro(parseInt(key), parseInt(key), i18n.__("validaAdvpl.deleteFrom"), erros_1.Severity.Warning));
                }
                if (linhaClean.search(/MSGBOX\(/) !== -1) {
                    objeto.aErros.push(new erros_1.Erro(parseInt(key), parseInt(key), i18n.__("validaAdvpl.msgBox"), erros_1.Severity.Information));
                }
                if (linha.search(/GETMV\(+(\ |\t|)+(\"|\')+MV_FOLMES+(\"|\')+(\ |\t|)\)/) !== -1) {
                    objeto.aErros.push(new erros_1.Erro(parseInt(key), parseInt(key), i18n.__("validaAdvpl.folMes"), erros_1.Severity.Information));
                }
                if (linha.search("\\<\\<\\<\\<\\<\\<\\<\\ HEAD") !== -1) {
                    ...
                    objeto.aErros.push(new erros_1.Erro(parseInt(key), parseInt(nFim), i18n.__("validaAdvpl.conflictMerge"), erros_1.Severity.Error));
                }
                if (linha.search(/(\ |\t|\'|\"|)+SELECT+(\ |\t)/) !== -1 &&
                    linha.search("\\ \\*\\ ") !== -1) {
                    objeto.aErros.push(new erros_1.Erro(parseInt(key), parseInt(key), i18n.__("validaAdvpl.selectAll"), erros_1.Severity.Warning));
                }
                if (linha.search("CHR\\(13\\)") !== -1 &&
                    linha.search("CHR\\(10\\)") !== -1) {
                    objeto.aErros.push(new erros_1.Erro(parseInt(key), parseInt(key), i18n.__("validaAdvpl.crlf"), erros_1.Severity.Warning));
                }
                ...
                this.ownerDb.forEach(banco => {
                    if (cSelect && FromQuery && linha.search(banco) !== -1) {
                        objeto.aErros.push(new erros_1.Erro(parseInt(key), parseInt(key), i18n.__("validaAdvpl.noSchema") +
                            banco +
                            i18n.__("validaAdvpl.inQuery"), erros_1.Severity.Error));
                    }
                });
                if (cSelect &&
                    ...
                    this.empresas.forEach(empresa => {
                        ...
                        palavras.forEach(palavra => {
                            if (palavra.search(empresa + "0") !== -1 &&
                                palavra.length === 6) {
                                objeto.aErros.push(new erros_1.Erro(parseInt(key), parseInt(key), i18n.__("validaAdvpl.tableFixed"), erros_1.Severity.Error));
                            }
                        });
                    });
                }
                ...
                if (linhaClean.search(/CONOUT\(/) !== -1) {
                    objeto.aErros.push(new erros_1.Erro(parseInt(key), parseInt(key), i18n.__("validaAdvpl.conout"), erros_1.Severity.Warning));
                }
                ...
                if ((linha.match(/(\ |\t|)+SELECT+(\ |\t)/) ||
                    ...
                    if (addErro) {
                        objeto.aErros.push(new erros_1.Erro(parseInt(key), parseInt(key), i18n.__("validaAdvpl.bestAnalitc") +
        ...
        if (!comentariosFonte) {
            objeto.aErros.push(new erros_1.Erro(0, 0, i18n.__("validaAdvpl.padComment"), erros_1.Severity.Information));
        }
        ...
        funcoes.forEach(funcao => {
            ...
            if (!achou) {
                objeto.aErros.push(new erros_1.Erro(parseInt(funcao[1]), parseInt(funcao[1]), i18n.__("validaAdvpl.functionNoCommented"), erros_1.Severity.Warning));
            }
        });
        ...
        comentFuncoes.forEach(comentario => {
            ...
            if (!achou) {
                objeto.aErros.push(new erros_1.Erro(parseInt(comentario[1]), parseInt(comentario[1]), i18n.__("validaAdvpl.CommentNoFunction"), erros_1.Severity.Warning));
            }
        });
