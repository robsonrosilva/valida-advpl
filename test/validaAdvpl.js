...
describe("Valida arquivo com erros", function() {
  ...
  describe("Confere erros encontrados", function() {
    ...
    it("Número de erros de código", async function() {
      ...
      fonte1.validacao(conteudo, "COM ERRO").then(() => {
        {
          assert.strictEqual(
            fonte1.error,
            2,
...
describe("Valida arquivo sem erros", function() {
  ...
  describe("Confere erros encontrados", function() {
    ...
    it("Número de erros de código", async function() {
      ...
      fonte2.validacao(conteudo, "SEM ERRO").then(() => {
        assert.strictEqual(
          fonte2.error,
          0,
...
describe("Valida arquivo REST", function() {
  ...
  describe("Confere erros encontrados", function() {
    ...
    it("Número de erros de código", async function() {
      ...
      fonte3.validacao(conteudo, "REST").then(() => {
        assert.strictEqual(
          fonte3.error,
          0,
...
describe("Valida arquivo WEBSRV", function() {
  ...
  describe("Confere erros encontrados", function() {
    ...
    it("Número de erros de código", async function() {
      ...
      fonte4.validacao(conteudo, "WEBSRV").then(() => {
        assert.strictEqual(
          fonte4.error,
          0,
